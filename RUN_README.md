...
```
docker run -p 8555:8555 -p 8556:8556 -p 9051:9051 --name btx-rpc-server -e BTXPWD='NEW_BTX_PWD' -e WEB="${WEB}" -e BOOTSTRAP="${BOOTSTRAP}" -v /home/bitcore:/home/bitcore:rw -d <repository>/btx-rpc-server
docker ps
```
...
```
docker run -p 8555:8555 -p 8556:8556 -p 9051:9051 --name btx-rpc-server -e BTXPWD='NEW_BTX_PWD' -e WEB="${WEB}" -e BOOTSTRAP="${BOOTSTRAP}" -v /home/bitcore:/home/bitcore:rw --entrypoint bash <repository>/btx-rpc-server
```
